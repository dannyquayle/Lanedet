import torch
from model.backbone import resnet, myyolo
import numpy as np
...
class parsingNet(torch.nn.Module):
    def __init__(self, size=(352, 640), pretrained=True, backbone='50', cls_dim=(37, 10, 4), use_aux=False):
